...
extern "C" FastRTPSPublisherAttributes FastRTPSGetPublisherAttributes(void* topicDataType, char* topicName) {
	...
	publisherAttributes.ReliablePublisher = AttributesFactory::ReliablePublisher((TopicDataType*)topicDataType, topicName); 
	publisherAttributes.MultimediaPublisher = AttributesFactory::MultimediaPublisher((TopicDataType*)topicDataType, topicName); 
